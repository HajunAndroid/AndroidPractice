...
public class Lab14_1DBHelper extends SQLiteOpenHelper {
    public static final int DATABASE_VERSION = 1;
    public Lab14_1DBHelper(Context context){
    ...
    public void onCreate(SQLiteDatabase db) {
        ...
        db.execSQL("insert into tb_data (category, location) values ('0','서울특별시시')");
